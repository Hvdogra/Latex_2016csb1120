...
Harshvardhan Dogra\\
       ...
       \affaddr{IIT Ropar}\\
       \affaddr{2016csb1120@iitrpr.ac.in}
% 2nd. author
\alignauthor
 Piyush Pilaniya\\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{IIT Ropar}\\
       \affaddr{2016csb1049@iitrpr.ac.in}
% 3rd. author
\and Gurkaranpreet Singh\\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{IIT Ropar}\\
       \affaddr{2014csb1013@iitrpr.ac.in}
  % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor Prinshu Kumar\\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{IIT Ropar}\\
       \affaddr{2016csb1051@iitrpr.ac.in}
}
\author{\IEEEauthorblockN{Harshvardhan Dogra}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar\\
Email: 2016csb1120@iitrpr.ac.in}
\and
\IEEEauthorblockN{Piyush Pilaniya}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar\\
Email: 2016csb1049@iitrpr.ac.in}
\and
\IEEEauthorblockN{Gurkaranpreet Singh}%\\ and Montgomery Scott}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar\\
Email: 2014csb1013@iitrpr.ac.in}
\and
\IEEEauthorblockN{Prinshu Kumar}%\\ and Montgomery Scott}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar\\
