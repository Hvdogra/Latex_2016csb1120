...
% 1st. author
\alignauthor
\DIFdelbegin \DIFdel{Harshvardhan Dogra}\DIFdelend \DIFaddbegin \DIFadd{Mukesh Saini}\DIFaddend \\
       \affaddr{Dept. of Computer Science }\\
       \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{National University of Singapore}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{2016csb1120@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \affaddr{mksaini@comp.nus.edu.sg}
\DIFaddend % 2nd. author
\alignauthor
 \DIFdelbegin \DIFdel{Piyush Pilaniya}\DIFdelend \DIFaddbegin \DIFadd{Raghudeep Gadde}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of Computer Science}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of ECE}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{National University of Singapore}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{2016csb1049@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \affaddr{elerdg@nus.edu.sg}
\DIFaddend % 3rd. author
\and \DIFdelbegin \DIFdel{Gurkaranpreet Singh}\DIFdelend \DIFaddbegin \DIFadd{Shuicheng Yan}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of Computer Science}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of ECE}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{National University of Singapore}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{2014csb1013@iitrpr.ac.in}
%DIFDELCMD <   %%%
\DIFdelend \DIFaddbegin \affaddr{eleyans@nus.edu.sg}
  \DIFaddend % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor \DIFdelbegin \DIFdel{Prinshu Kumar}\DIFdelend \DIFaddbegin \DIFadd{Wei Tsang Ooi}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{IIT Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{National University of Singapore}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{2016csb1051@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \affaddr{ooiwt@comp.nus.edu.sg}
\DIFaddend }
...
\textbf{Categories and Subject Descriptors:} I.2.10 [Vision and Scene Understanding]: Video Analysis \\\textbf{General Terms:} Algorithms, Design.\\\textbf{Keywords:} Mobile Video, Virtual Director, Video Mashup.
\end{abstract}
...
\DIFaddbegin \DIFadd{Just keep visiting down!!}\\
\DIFaddend In this section, we ﬁrst enumerate the design principles that we have followed in the development of MoViMash and then describe the framework. After an overview of MoViMash, we focus on individual components.



\subsection{Design Principles}
\DIFaddbegin \DIFadd{Well save your time, as there are no changes in the sub-sections!}\\
\DIFaddend The end goal of the MoViMash is to produce a mashup that users like. To achieve this goal, we have followed a set of design principles as follows:
\begin{itemize}
